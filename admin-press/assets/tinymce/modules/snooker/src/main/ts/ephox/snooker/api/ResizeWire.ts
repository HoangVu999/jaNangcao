...
// view: the container who listens to mouse events from contentImage tables (eg, detached/inline mode)
//       or the document that is a common ancestor of both the contentImage tables and the
