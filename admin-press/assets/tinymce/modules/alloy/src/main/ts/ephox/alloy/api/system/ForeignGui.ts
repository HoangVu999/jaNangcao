 ...
 * an iframe of an editor. We did not create the contentImage (it is also volatile), but we still
 ...
 * for iframes, it would often be inserted at the document level so that it wasn't in the contentImage),
