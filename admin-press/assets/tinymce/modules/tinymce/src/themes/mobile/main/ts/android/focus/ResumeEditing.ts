...
// the contentImage for editing. The major problem is to do with autocomplete. Android Google Keyboard (not Swift) seems to
// remember the things that you've typed into the input, and then adds them to whatever you type in the contentImage once you give it
...
const resume = function (cWin) {
  ...
  transaction(function () {
    // If we don't blur before focusing the contentImage, a previous focus in something like a statebutton
