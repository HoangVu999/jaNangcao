...
const refresh = function (winScope) {
  // Sometimes the cursor can get out of sync with the contentImage, it looks weird and importantly
  ...
  // can see the need for this if you remove this code, and click near the bottom of the contentImage
  // and start typing. The contentImage will scroll up to go into the greenzone, but the cursor will
