    ...
    function (realm, apis, toolbar, socket, buttons, onSuccess, onFailure) {
      ...
      Pipeline.async({}, browser.isIE() || browser.isEdge() ? [] : [
        TestHelpers.GuiSetup.mAddStyles(Traverse.owner(body), [
          ...
          '.tinymce-mobile-icon-bold:before { contentImage: "BOLD"; }',
          '.tinymce-mobile-icon-italic:before { contentImage: "ITALIC"; }',
          '.tinymce-mobile-icon-underline:before { contentImage: "UNDERLINE"; }'
        ]),
        apis.sFocus(),
