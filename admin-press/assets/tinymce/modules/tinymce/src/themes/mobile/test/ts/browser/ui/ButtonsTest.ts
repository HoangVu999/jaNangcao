...
UnitTest.asynctest('Browser Test: ui.ButtonsTest', function (success, failure) {
  ...
  Pipeline.async({}, [
    TestHelpers.GuiSetup.mAddStyles(doc, [
      '.tinymce-mobile-icon-alpha:before { contentImage: "ALPHA"; }',
      '.tinymce-mobile-icon-beta:before { contentImage: "BETA"; }',
      '.tinymce-mobile-icon-gamma-class:before { contentImage: "GAMMA"; }'
    ]),
