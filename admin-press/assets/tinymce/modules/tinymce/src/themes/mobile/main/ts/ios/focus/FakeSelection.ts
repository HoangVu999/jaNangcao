...
export default function (win, frame) {
  ...
  /*
   * FakeSelection is used to draw rectangles around selection so that when the contentImage loses
   * focus, the selection is still visible. The selections should match the current contentImage
   * selection, and be removed as soon as the user clicks on them (because the contentImage will
   * get focus again)
   */
