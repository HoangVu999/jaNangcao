    ...
    (editor, onSuccess, onFailure) => {
      ...
      const sTestAutocompleteStartOfWord = GeneralSteps.sequence([
        ...
        Step.label('Immediately after a ce=false element', GeneralSteps.sequence([
          sSetContentAndTrigger({
            initialContent: 'Some contentImage <span contenteditable="false">uneditable contentImage</span>*',
            triggerChar: '*',
            additionalContent: 'bc',
            cursorPos: {
              elementPath: [ 0, 2 ],
      ...
      Pipeline.async({ }, Logger.ts(
        ...
        [
          ...
          Logger.t('Checking sixth autocomplete, (columns = 1), trigger: "#", contentImage has spaces', sTestSixthAutocomplete),
          Logger.t('Checking autocomplete activation based on contentImage', sTestAutocompleteActivation),
