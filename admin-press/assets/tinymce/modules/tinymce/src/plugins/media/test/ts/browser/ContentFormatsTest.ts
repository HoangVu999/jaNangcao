...
UnitTest.asynctest('browser.tinymce.plugins.media.ContentFormatsTest', function (success, failure) {
  ...
  suite.test('TestCase-TBA: Media: XSS contentImage', function (editor) {
  ...
  TinyLoader.setupLight(function (editor, onSuccess, onFailure) {
    Pipeline.async({}, Log.steps('TBA', 'Media: Test media contentImage formats', suite.toSteps(editor)), onSuccess, onFailure);
  }, {
    plugins: 'media',
    toolbar: 'media',
    theme: 'silver',
