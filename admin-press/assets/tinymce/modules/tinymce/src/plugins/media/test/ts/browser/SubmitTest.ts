...
UnitTest.asynctest('browser.core.SubmitTest', (success, failure) => {
  ...
  TinyLoader.setupLight(function (editor, onSuccess, onFailure) {
    ...
    Pipeline.async({}, [
      Log.stepsAsStep(
        'TBA',
        'Media: Open dialog, set url, submit dialog and assert contentImage. ' +
        'Change setting and assert changed contentImage', [
      ...
      Log.stepsAsStep('TBA', 'Media: Open dialog, set embed contentImage, submit dialog and assert contentImage.', [
