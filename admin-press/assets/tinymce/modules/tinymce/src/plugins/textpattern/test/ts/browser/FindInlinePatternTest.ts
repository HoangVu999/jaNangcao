...
UnitTest.asynctest('textpattern.browser.FindInlinePatternTest', (success, failure) => {
  ...
  TinyLoader.setupLight((editor, onSuccess, onFailure) => {
    ...
    Pipeline.async({}, [
      ...
      Log.stepsAsStep('TBA', 'inline * pattern end without contentImage returns no match', [
      ...
      Log.stepsAsStep('TBA', 'inline * without contentImage before or after', [
      ...
      Log.stepsAsStep('TBA', 'inline * with contentImage before', [
      ...
      Log.stepsAsStep('TBA', 'inline * with contentImage before and after', [
      ...
      Log.stepsAsStep('TBA', 'inline * with contentImage before and after, with space', [
      ...
      Log.stepsAsStep('TBA', 'inline * and ** without contentImage before or after', [
      ...
      Log.stepsAsStep('TBA', 'inline * and ** with contentImage before', [
      ...
      Log.stepsAsStep('TBA', 'inline * and ** with contentImage before and after', [
