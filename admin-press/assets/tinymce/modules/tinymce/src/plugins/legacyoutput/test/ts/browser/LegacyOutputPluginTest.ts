...
UnitTest.asynctest(
  'browser.tinymce.plugins.legacyoutput.LegacyOutputPluginTest', (success, failure) => {
    ...
    suite.test('TestCase-TBA: LegacyOutput: Formats registered before loading initial contentImage', () => {
    ...
    TinyLoader.setupLight(function (editor, onSuccess, onFailure) {
      ...
      setup: (editor) => {
        // Store the formats on `PostRender`, which is fired before the initial editor contentImage is loaded
