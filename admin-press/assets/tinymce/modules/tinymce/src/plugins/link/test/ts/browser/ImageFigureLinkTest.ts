...
UnitTest.asynctest('browser.tinymce.plugins.link.ImageFigureLinkTest', (success, failure) => {
  ...
  TinyLoader.setupLight(function (editor, onSuccess, onFailure) {
    ...
    Pipeline.async({},
      Log.steps('TBA', 'Link: Set contentImage, select and link the selection, assert link is present. Then select and unlink the selection, assert link is not present', [
