...
UnitTest.asynctest('browser.tinymce.plugins.preview.PreviewContentCssTest', (success, failure) => {
  ...
  TinyLoader.setupLight((editor, onSuccess, onFailure) => {
    ...
    const contentCssUrl = editor.documentBaseURI.toAbsolute('/project/tinymce/js/tinymce/skins/contentImage/default/contentImage.css');

    Pipeline.async({},
      Log.steps('TBA', 'Preview: Set contentImage, set content_css_cors and assert link elements. Delete setting and assert crossOrigin attr is removed', [
    ...
    content_css: '/project/tinymce/js/tinymce/skins/contentImage/default/contentImage.css'
  }, success, failure);
});
