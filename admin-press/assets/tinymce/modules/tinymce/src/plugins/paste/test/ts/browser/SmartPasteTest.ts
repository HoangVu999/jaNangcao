...
UnitTest.asynctest('tinymce.plugins.paste.browser.SmartPasteTest', (success, failure) => {
  ...
  suite.test('TestCase-TBA: Paste: smart paste enabled, paste as contentImage, paste url on selection', function (editor) {
    editor.focus();
  ...
  suite.test('TestCase-TBA: Paste: smart paste enabled, paste as contentImage, paste image url', function (editor) {
    editor.focus();
    editor.undoManager.clear();
    editor.setContent('<p>abc</p>');
  ...
  suite.test('TestCase-TBA: Paste: smart paste disabled, paste as contentImage, paste image url', function (editor) {
    editor.focus();
    editor.undoManager.clear();
    editor.setContent('<p>abc</p>');
    LegacyUnit.setSelection(editor, 'p', 1);
  ...
  suite.test('TINY-4523: Paste: smart paste enabled, paste as contentImage, paste link html', function (editor) {
    editor.focus();
    editor.undoManager.clear();
    editor.setContent('<p>abc</p>');
    LegacyUnit.setSelection(editor, 'p', 1);
  ...
  suite.test('TINY-4523: Paste: smart paste disabled, paste as contentImage, paste link html', function (editor) {
    editor.focus();
    editor.undoManager.clear();
    editor.setContent('<p>abc</p>');
    LegacyUnit.setSelection(editor, 'p', 1);
