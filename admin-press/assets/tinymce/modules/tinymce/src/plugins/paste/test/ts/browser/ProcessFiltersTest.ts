  ...
  TinyLoader.setupLight(function (editor, onSuccess, onFailure) {
    Pipeline.async({}, [
      ...
      Chain.asStep(editor, Log.chains('TBA', 'Paste: Paste pre/post process passthough as is', [
        ...
        Assertions.cAssertEq('Should be unchanged with safe contentImage', { content: 'a', cancelled: false })
      ])),

      Chain.asStep(editor, Log.chains('TBA', 'Paste: Paste pre/post process passthough unsafe contentImage', [
        cProcessPrePost(`<img src="non-existent.png" onerror="alert('!')">`, true, Fun.noop, Fun.noop),
        Assertions.cAssertEq('Should be changed if dangerous contentImage', { content: '<img src="non-existent.png">', cancelled: false })
      ])),
