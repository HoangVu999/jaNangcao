...
/**
 * Checks if the specified contentImage is from any of the following sources: MS Word/Office 365/Google docs.
 */
...
const filterWordContent = function (editor: Editor, content: string) {
  ...
  content = Utils.filter(content, [
    ...
    // Remove comments, scripts (e.g., msoShowComment), XML tag, VML contentImage,
