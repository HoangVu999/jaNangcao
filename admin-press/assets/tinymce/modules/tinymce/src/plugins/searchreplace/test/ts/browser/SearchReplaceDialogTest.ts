...
UnitTest.asynctest('browser.tinymce.plugins.searchreplace.SearchReplaceDialogTest', (success, failure) => {
  ...
  TinyLoader.setupInBodyAndShadowRoot((editor, onSuccess, onFailure) => {
    ...
    Pipeline.async({}, [
      Log.stepsAsStep('TBA', 'SearchReplace: Test no contentImage selected', [
      ...
      Log.stepsAsStep('TBA', 'SearchReplace: Test some contentImage selected', [
        tinyApis.sSetContent('<p>fish fish fish</p>'),
      ...
      Log.stepsAsStep('TBA', 'SearchReplace: Test some contentImage selected with matchcase enabled', [
        tinyApis.sSetContent('<p>fish Fish fish</p>'),
        tinyApis.sSetSelection([ 0, 0 ], 5, [ 0, 0 ], 9),
        Utils.sOpenDialog(tinyUi),
        Utils.sAssertFieldValue(tinyUi, 'input.tox-textfield[placeholder="Find"]', 'Fish'),
      ...
      Log.stepsAsStep('TBA', 'SearchReplace: Test some contentImage selected with wholewords enabled', [
      ...
      Log.stepsAsStep('TINY-4549', 'SearchReplace: Test some contentImage selected with in selection enabled', [
        tinyApis.sSetContent('<p>ttt TTT ttt ttttt</p>'),
      ...
      Log.stepsAsStep('TBA', 'SearchReplace: Test some contentImage selected while changing preferences', [
