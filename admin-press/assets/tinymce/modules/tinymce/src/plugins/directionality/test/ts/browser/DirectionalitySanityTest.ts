...
UnitTest.asynctest(
  'browser.tinymce.plugins.directionality.DirectionalitySanityTest', (success, failure) => {
    ...
    TinyLoader.setupLight(function (editor, onSuccess, onFailure) {
      ...
      Pipeline.async({},
        Log.steps('TBA', 'Directionality: Set and select contentImage, click on the Right to left toolbar button and assert direction is right to left. Now, click on the Left to right button and assert direction is left to right', [
