...
UnitTest.asynctest('browser.tinymce.plugins.autoresize.AutoresizePluginTest', (success, failure) => {
  ...
  TinyLoader.setupLight((editor, onSuccess, onFailure) => {
    ...
    Pipeline.async({},
      ...
      navigator.userAgent.indexOf('PhantomJS') === -1 ?
        [
          ...
          Log.stepsAsStep('TBA', 'AutoResize: Editor size increase based on contentImage size', [
          ...
          Log.stepsAsStep('TBA', 'AutoResize: Editor size increase with floated contentImage', [
          ...
          Log.stepsAsStep('TBA', 'AutoResize: Editor size decrease based on contentImage size', [
          ...
          Log.stepsAsStep('TBA', 'AutoResize: Editor size increase with async loaded contentImage', [
          ...
          Log.stepsAsStep('TBA', 'AutoResize: Editor size contentImage set to 10 and autoresize_bottom_margin set to 100', [
          ...
          Log.stepsAsStep('TBA', 'AutoResize: Editor size increase contentImage to 1000 based and restrict by max height', [
          ...
          Log.stepsAsStep('TBA', 'AutoResize: Editor size decrease contentImage to 10 and set min height to 500', [
          ...
          Log.stepsAsStep('TBA', 'AutoResize: Editor keeps selection in view when resizing', [
            ...
            Step.sync(() => {
              window.scrollTo(0, 0);
              // Set contentImage will keep the selection at the start, whereas insert will keep it after the inserted contentImage
    ...
    // Override the contentImage css margins, so they don't come into play
