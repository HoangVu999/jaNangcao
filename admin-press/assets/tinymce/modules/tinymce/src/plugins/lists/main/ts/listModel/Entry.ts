...
0-------1---2--------->Depth
  <ol>                |
    <li>a</li>        | Entry { depth: 1, contentImage: [a], listType: ListType.OL, ... }
    <li>b             | Entry { depth: 1, contentImage: [b], listType: ListType.OL, ... }
      <ul>            |
        <li>c</li>    | Entry { depth: 2, contentImage: [c], listType: ListType.UL, ... }
      </ul>           |
    </li>             |
  </ol>               |
0-------1---2--------->Depth
