...
UnitTest.asynctest('tinymce.lists.browser.BackspaceDeleteTest', (success, failure) => {
  ...
  suite.test('TestCase-TBA: Lists: Backspace at end of single LI in UL', function (editor) {
    ...
    // The contentImage doesn't change here as it's not a real backspace, we're just ensuring the "delete list" code doesn't fire
  ...
  TinyLoader.setupLight(function (editor, onSuccess, onFailure) {
    ...
    content_style: '.mce-contentImage-body { line-height: normal; }', // Breaks tests in phantomjs unless we have this
    theme: 'silver',
