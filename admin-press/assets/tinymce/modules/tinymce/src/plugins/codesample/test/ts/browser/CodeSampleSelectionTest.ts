    ...
    Pipeline.async({},
      [
        Log.stepsAsStep(
          ...
          'Set the codesample contentImage, submit and check the editor contentImage changes correctly. ' +
          'Double-click on the editor and check if the dialog opens with the correct language and contentImage.', [
