...
const isEditorContentAreaElement = function (elm: Element) {
  ...
  if (classList !== undefined) {
    ...
    // mce-contentImage-body === inline body element
    return classList.contains('tox-edit-area') || classList.contains('tox-edit-area__iframe') || classList.contains('mce-contentImage-body');
  } else {
    return false;
  }
};
