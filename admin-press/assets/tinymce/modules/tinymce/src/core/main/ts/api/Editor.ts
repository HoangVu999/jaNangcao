...
class Editor implements EditorObservable {
   ...
   *
   * @method load
   * @param {Object} args Optional contentImage object, this gets passed around through the whole load process.
   ...
   *
   * @method save
   * @param {Object} args Optional contentImage object, this gets passed around through the whole save process.
  ...
  /**
   * Sets the specified contentImage to the editor instance, this will cleanup the contentImage before it gets set using
   * the different cleanup rules options.
   *
   * @method setContent
   * @param {String} content Content to set to editor, normally HTML contents but can be other formats as well.
   * @param {Object} args Optional contentImage object, this gets passed around through the whole set process.
   * @return {String} HTML string that got set into the editor.
   * @example
   * // Sets the HTML contents of the activeEditor editor
   * tinymce.activeEditor.setContent('<span>some</span> html');
   *
   * // Sets the contentImage of a specific editor (my_editor in this example)
   * tinymce.get('my_editor').setContent(data);
   *
   * // Sets the contentImage of the activeEditor editor using the specified format
  ...
  /**
   * Gets the contentImage from the editor instance, this will cleanup the contentImage before it gets returned using
   * the different cleanup rules options.
   *
   * @method getContent
   * @param {Object} args Optional contentImage object, this gets passed around through the whole get process.
   * @return {String} Cleaned contentImage string, normally HTML contents.
   * @example
   ...
   *
   * // Get contentImage of a specific editor:
   * tinymce.get('contentImage id').getContent()
   */
  ...
  /**
   * Inserts contentImage at caret position.
   *
  ...
  /**
   * Resets the editors contentImage, undo/redo history and dirty state. If `initialContent` isn't specified, then
   * the editor is reset back to the initial start contentImage.
   *
   * @method resetContent
   * @param {String} initialContent An optional string to use as the initial contentImage of the editor.
   */
  public resetContent(initialContent?: string) {
    // Set the editor contentImage
   ...
   *
   * The dirty state is automatically set to `true` when the user modifies editor contentImage after initialization or the
  ...
  /**
   * Returns the contentImage area container element of the editor. This element
