...
const registry = () => {
  ...
  return {
     ...
     * is matched in the contentImage while typing, the autocompleter will be triggered.
     ...
     * form element appearing when a contentImage predicate is matched. An example
    ...
    /**
     * Registers a new context menu section that only appears when a contentImage predicate is matched,
    ...
    /**
     * Registers a new context toolbar that only appears when a contentImage predicate is matched for example
