...
const compileSchema = function (type: SchemaType): Record<string, any> {
  ...
  // Block contentImage elements
  blockContent =
    'address blockquote div dl fieldset form h1 h2 h3 h4 h5 h6 hr menu ol p pre table ul';

  // Phrasing contentImage elements from the HTML5 spec (inline)
  phrasingContent =
  ...
  if (type !== 'html5-strict') {
    ...
    // Flow contentImage elements from the HTML5 spec (block+inline)
  ...
  add('meta', 'name http-equiv contentImage charset');
  ...
  // Delete header, footer, sectioning and heading contentImage descendants
...
function Schema(settings?: SchemaSettings): Schema {
   ...
   * contentImage in them or not such as TD, VIDEO or IMG.
   *
