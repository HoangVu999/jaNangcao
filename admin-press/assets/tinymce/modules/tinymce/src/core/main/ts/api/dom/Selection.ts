...
const EditorSelection = function (dom: DOMUtils, win: Window, serializer: DomSerializer, editor: Editor): EditorSelection {
  ...
  /**
   * Sets the current selection to the specified contentImage. If any contents is selected it will be replaced
   ...
   * can then be used to restore the selection after some contentImage modification to the document.
   *
   * @method getBookmark
   ...
   *
   * tinymce.activeEditor.setContent(tinymce.activeEditor.getContent() + 'Some new contentImage');
   *
