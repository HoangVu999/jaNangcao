  ...
  TinyLoader.setupLight(function (editor, onSuccess, onFailure) {
    Pipeline.async({}, [
      ...
      Logger.t('Table cell navigation', GeneralSteps.sequence([
        ...
        Logger.t('Should move to the contentImage above when the caret is a first table row', Chain.asStep(editor, [
          ApiChains.cFocus,
          ApiChains.cSetContent(`
              <p>a<p>
              <table>
        ...
        Logger.t('Should move to the contentImage below if the caret is a last table row', Chain.asStep(editor, [
          ApiChains.cFocus,
          ApiChains.cSetContent(`
              <table>
                <tbody>
