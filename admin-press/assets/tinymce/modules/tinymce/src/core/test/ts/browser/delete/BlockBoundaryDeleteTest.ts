...
UnitTest.asynctest('browser.tinymce.core.delete.BlockBoundaryDeleteTest', function (success, failure) {
  ...
  TinyLoader.setupLight(function (editor, onSuccess, onFailure) {
    ...
    Pipeline.async({}, [
      ...
      Logger.t('Backspace from empty block into contentImage block should merge', GeneralSteps.sequence([
      ...
      Logger.t('Delete from empty block into contentImage block should merge', GeneralSteps.sequence([
