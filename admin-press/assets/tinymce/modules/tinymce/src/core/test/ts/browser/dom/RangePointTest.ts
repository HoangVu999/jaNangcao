...
UnitTest.asynctest('browser.tinymce.core.dom.RangePointsTest', (success, failure) => {
  ...
  TinyLoader.setupLight((editor, onSuccess, onFailure) => {
    ...
    Pipeline.async({}, [
      ...
      Logger.t('point in text contentImage selection', GeneralSteps.sequence([
        tinyApis.sSetContent('<p>Some text contentImage</p>'),
    ...
    content_style: 'body.mce-contentImage-body, p { margin: 0 }'
  }, success, failure);
});
