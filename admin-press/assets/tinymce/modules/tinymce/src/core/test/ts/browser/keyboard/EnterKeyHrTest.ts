...
UnitTest.asynctest('browser.tinymce.core.keyboard.EnterKeyHrTest', function (success, failure) {
  ...
  TinyLoader.setupLight(function (editor, onSuccess, onFailure) {
    ...
    Pipeline.async({}, [
      ...
      Logger.t('Enter before HR in the beginning of contentImage', GeneralSteps.sequence([
      ...
      Logger.t('Enter after HR in the beginning of contentImage', GeneralSteps.sequence([
        tinyApis.sSetContent('<hr /><p>a</p>'),
      ...
      Logger.t('Enter before HR in the middle of contentImage', GeneralSteps.sequence([
      ...
      Logger.t('Enter after HR in the middle of contentImage', GeneralSteps.sequence([
        tinyApis.sSetContent('<p>a</p><hr /><p>b</p>'),
      ...
      Logger.t('Enter before HR in the end of contentImage', GeneralSteps.sequence([
        tinyApis.sFocus(),
      ...
      Logger.t('Enter after HR in the end of contentImage', GeneralSteps.sequence([
        tinyApis.sFocus(),
        tinyApis.sSetContent('<p>a</p><hr />'),
        tinyApis.sSetCursor([], 2),
        tinyActions.sContentKeystroke(Keys.enter(), {}),
