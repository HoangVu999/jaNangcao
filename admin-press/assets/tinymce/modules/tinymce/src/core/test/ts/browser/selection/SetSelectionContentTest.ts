...
UnitTest.asynctest('browser.tinymce.selection.SetSelectionContentTest', function (success, failure) {
  ...
  TinyLoader.setupLight(function (editor, onSuccess, onFailure) {
    ...
    Pipeline.async({}, [
      ...
      Log.stepsAsStep('TBA', 'Insert contentImage in middle of word, expanded selection', [
      ...
      Log.stepsAsStep('TBA', 'Insert contentImage in middle of word, collapsed selection', [
      ...
      Log.stepsAsStep('TBA', 'Insert contentImage at start of word, collapsed selection', [
      ...
      Log.stepsAsStep('TBA', 'Insert contentImage at end of word, collapsed selection', [
        tinyApis.sSetContent('<p>a</p>'),
        tinyApis.sSetCursor([ 0, 0 ], 1),
        sSetContent(editor, 'X', {}),
        Assertions.sAssertStructure('Checking initial structure',
      ...
      Log.stepsAsStep('TBA', 'Insert contentImage at end of word with partial text', [
        tinyApis.sSetContent('<p>a</p>'),
        tinyApis.sSetCursor([ 0, 0 ], 1),
      ...
      Log.stepsAsStep('TINY-5966', 'Set text contentImage at end of word with a space', [
        tinyApis.sSetContent('<p>a&nbsp;</p>'),
      ...
      Log.stepsAsStep('TINY-5966', 'Set text contentImage with leading/trailing spaces', [
      ...
      Log.stepsAsStep('TINY-5966', 'Set text contentImage in between 2 nbsps', [
      ...
      Log.stepsAsStep('TINY-5966', 'Set text contentImage into empty block with leading/trailing spaces', [
        tinyApis.sSetContent('<p></p>'),
        tinyApis.sSetCursor([ 0, 0 ], 0),
        sSetContent(editor, ' a b ', {}),
        Assertions.sAssertStructure('Checking initial structure',
      ...
      Log.stepsAsStep('TINY-5966', 'Set text contentImage into empty pre block with leading/trailing spaces', [
      ...
      Log.stepsAsStep('TINY-5966', 'Set text contentImage into pre block using a range selection', [
