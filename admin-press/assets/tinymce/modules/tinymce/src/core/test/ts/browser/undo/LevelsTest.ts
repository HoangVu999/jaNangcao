...
UnitTest.asynctest('browser.tinymce.core.undo.LevelsTest', function (success, failure) {
  ...
  suite.test('applyToEditor to equal contentImage with complete level', function (editor) {
  ...
  suite.test('applyToEditor to different contentImage with complete level', function (editor) {
  ...
  suite.test('applyToEditor to different contentImage with fragmented level', function (editor) {
