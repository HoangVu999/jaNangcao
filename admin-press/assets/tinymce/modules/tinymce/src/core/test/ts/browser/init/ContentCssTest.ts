...
UnitTest.test('browser.tinymce.core.init.ContentCssTest', () => {
  ...
  const skinsBaseUrl = EditorManager.baseURL + '/skins/contentImage';
  ...
  testContentCss('Expected default contentImage css on undefined value', [ `${skinsBaseUrl}/default/content.css` ], undefined);
  testContentCss('Expected array with absolute url from .css file name', [ `${baseUrl}/test.css` ], 'test.css');
  testContentCss('Expected array with absolute url from relative string', [ `${baseUrl}/content/test.css` ], '/contentImage/test.css');
  testContentCss('Expected array with absolute url from array with relative string', [ `${baseUrl}/content/test.css` ], [ '/contentImage/test.css' ]);
  testContentCss('Expected array with two absolute urls from an array of relative strings',
    ...
    [ '/contentImage/a.css', '/contentImage/b.css' ]
  );
