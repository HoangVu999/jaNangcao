...
UnitTest.asynctest('browser.tinymce.core.contentImage.PlaceholderVisuallyEmptyTest', (success, failure) => {
  Theme();
  ...
  TinyLoader.setupLight((editor, onSuccess, onFailure) => {
    ...
    Pipeline.async({}, [
      Log.stepsAsStep('TINY-3917', 'Check initial contentImage is empty', [
        sAssertEmpty('Check base empty contentImage', true, true)
      ]),
      Log.stepsAsStep('TINY-3917', 'Check contentImage is visually empty - forced_root_block: "p"', [
        sTestEmpty('<p></p>'),
        sTestEmpty('<p><br /></p>'),
      ...
      Log.stepsAsStep('TINY-3917', 'Check contentImage is visually empty - forced_root_block: false', [
        sTestEmpty('', true),
        sTestEmpty('<br />', true),
      ...
      Log.stepsAsStep('TINY-3917', 'Check contentImage is NOT visually empty - forced_root_block: "p"', [
      ...
      Log.stepsAsStep('TINY-3917', 'Check contentImage is NOT visually empty - forced_root_block: false', [
