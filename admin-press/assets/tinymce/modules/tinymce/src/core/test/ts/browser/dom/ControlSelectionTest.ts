  ...
  TinyLoader.setupLight((editor, onSuccess, onFailure) => {
    ...
    Pipeline.async({}, [
      Log.stepsAsStep('TBA', 'Select image by context menu clicking on it', [
        ...
        Step.label('Set editor contentImage to a paragraph with a image within', tinyApis.sSetContent('<p><img src="http://www.google.com/google.jpg" width="100" height="100"></p>')),
    ...
    content_style: 'body.mce-contentImage-body  { margin: 0 }',
    width: 800
  }, success, failure);
});
