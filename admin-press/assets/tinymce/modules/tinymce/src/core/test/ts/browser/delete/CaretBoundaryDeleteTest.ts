...
UnitTest.asynctest('browser.tinymce.core.delete.CaretBoundaryDeleteTest', (success, failure) => {
  ...
  const sTestDelete = (editor: Editor, tinyApis: TinyApis, tinyActions: TinyActions) => GeneralSteps.sequence([
    ...
    Log.stepsAsStep('TINY-2998', 'Should add fake caret if we delete contentImage beside cef elements', [
    ...
    Log.stepsAsStep('TINY-4211', 'Should add fake caret if we type and then delete contentImage beside media elements', [
