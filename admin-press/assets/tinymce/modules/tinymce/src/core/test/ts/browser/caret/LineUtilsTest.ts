...
UnitTest.test('browser.tinymce.core.LineUtilsTest - findLineNodeRects', () => {
  ...
  const para = SugarElement.fromHtml('<p>Paragraph with contentImage</p>');
  const multiLinePara = SugarElement.fromHtml('<p>Multiple line <br>paragraph with contentImage</p>');
