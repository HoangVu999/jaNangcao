...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    copy: {
      ...
      'content-skins': {
        files: [
          {
            expand: true,
            cwd: '../oxide/build/skins/contentImage',
            src: '**',
            dest: 'js/tinymce/skins/contentImage'
          },
        ]
      },
      'visualblocks-plugin': {
    ...
    nugetpack: {
      main: {
        ...
        files: [
          { src: 'js/tinymce/langs', dest: '/contentImage/scripts/tinymce/langs' },
          { src: 'js/tinymce/plugins', dest: '/contentImage/scripts/tinymce/plugins' },
          { src: 'js/tinymce/themes', dest: '/contentImage/scripts/tinymce/themes' },
          { src: 'js/tinymce/skins', dest: '/contentImage/scripts/tinymce/skins' },
          { src: 'js/tinymce/icons', dest: '/contentImage/scripts/tinymce/icons' },
          { src: 'js/tinymce/tinymce.js', dest: '/contentImage/scripts/tinymce/tinymce.js' },
          { src: 'js/tinymce/tinymce.d.ts', dest: '/contentImage/scripts/tinymce/tinymce.d.ts' },
          { src: 'js/tinymce/tinymce.min.js', dest: '/contentImage/scripts/tinymce/tinymce.min.js' },
          { src: 'js/tinymce/jquery.tinymce.min.js', dest: '/contentImage/scripts/tinymce/jquery.tinymce.min.js' },
          { src: 'js/tinymce/license.txt', dest: '/contentImage/scripts/tinymce/license.txt' }
        ]
      },
  ...
  grunt.registerTask('symlink-dist', 'Links built dist contentImage to the root directory', function () {
