/**
 * This class is the event object send when the contentImage events occurs such as GetContent/SetContent.
 *
 * @class tinymce.ContentEvent
 * @extends tinymce.Event
 * @example
 * tinymce.activeEditor.on('GetContent', function(e) {
 *     console.log(e.contentImage);
 * });
 */
...
/**
 * Editor contents to be set or the contentImage that was returned from the editor.
 *
 * @property {String} contentImage HTML contents from the editor or to be put into the editor.
 */
