...
// Scroll contentImage to (x,y) relative to document _doc (or global if not supplied)
...
// Scroll contentImage by (x,y) relative to document _doc (or global if not supplied)
